...
<section id="the_moment" class="blue_gradient">
    ...
    <style>
        ...
        .section_title_wrap .section_title{
            font-family: 'flexo black', 'flexo bold', flexo, sans-serif;
            font-style: normal;
            font-weight: 900; 
            font-size: 72px;
            line-height: 1;
    ...
    <div class="grid-x icon_text_row even">			
        ...
        <div class="cell text-container">
            <div class="text_box">
                ...
                <div class="text">
                    <p>Our neutral safe haven allows you to connect data across more data sources, and partners to build deeper customer intelligence. <a href="https://liveramp.com/safe-haven-data-partnerships/" data-wpel-link="internal">Check this out.</a></p>
                </div>
            </div>
        </div>
    </div>
    <div class="grid-x icon_text_row odd">
        ...
        <div class="cell text-container">
            <div class="text_box"> 
                ...
                <div class="text">
                    <p>Our market-leading identity infrastructure integrated with the largest partner network lets you create data-driven customer experiences—without relying on traditional digital user IDs. <a href="https://liveramp.com/our-platform/identity-infrastructure/" data-wpel-link="internal">Here’s what we mean.</a> </p>
                </div>
            </div>
        </div>
    </div>
    <div class="grid-x icon_text_row even">
        ...
        <div class="cell text-container">
            <div class="text_box"> 
                ...
                <div class="text">
                    <p>Understand the business impact of every marketing activity with holistic data connectivity. <a href="https://liveramp.com/our-platform/cross-channel-measurement/" data-wpel-link="internal">Only LiveRamp does this.</a> </p>
                </div>
            </div>
        </div>
    </div>
            ...
            color: #003865;
					...
					<div class="flex-container startTheDiscussion">
						...
						<div class="live-discussion-desc">
						  ...
						  <a class="button" target="" href="https://liveramp.com/contact" data-wpel-link="internal">Seize the moment</a>
						</div>
					</div>	    			
		</div>
	    </div>
