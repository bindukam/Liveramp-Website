<?php /* Template Name: Brand Campaign Opt */ ?>

<?php get_header(); ?>
<link rel="stylesheet" type="text/css" href="/wp-content/themes/liveRamp-Template/brand-campagin.css"/>

<!--Banner section -->
<section class="velocity-banner-section">
<!--section class="home" id="home"-->
 ...
 <!--video section -->
 <section id=""  class="velocity-video-section">
 <!--section id="feeling_section"  class="feelingSec"-->
    <div class="grid-container">
        ...
        <div class="v_play_wrap">
            ...
            <div class="wistia_embed wistia_async_n01lnzd5bw wistia_embed_custom seo=false">
 ...
 <!-- The Wave section -->
<section id="" class="velocity-quote-logo-section blue_gradient">
...
<section class="velocity_icon_text_left_right pad-section entrance-anim">
<!--section class="icon_text_left_right vector-wave-section pad-section entrance-anim"-->
    ...
    <div class="grid-x icon_text_row even">
        ...
        <div class="cell image-container">
            <img src="<?php echo get_template_directory_uri() ?>/dist/assets/images/brand-campaign/UltraHD_expanded.svg" class="lsh-features_image">
        </div>
    ...
    <div class="grid-x icon_text_row odd">
        ...
        <div class="cell image-container">
            <img src="<?php echo get_template_directory_uri() ?>/dist/assets/images/brand-campaign/Activate_expanded.svg" class="lsh-features_image">
        </div>
...
<section class="velocity_resource_3_card_image_and_text resource_3_card_image_and_text no_spacer entrance-anim">
