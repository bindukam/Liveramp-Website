 ...
 */
	...
	if( $external_link = get_field('marketo', $post->ID) ) { //
		...
		<div class="grid-x align-center header-grid <?php echo $big_header ?>">
			<div class="cell breadcrumbs-wrapper">
				<div class="breadcrumbs-cell white">
					<p id="breadcrumbs">
						<a href="/resources"><?php _translate('back_to_resources') ?></a>
					</p>
				</div>
			...
			<div class="medium-8 article <?php echo $overlay ?>" id="article">
				...
				?>
					...
					<div class="feature-image-wrapper header">
						<div class="featured-hero b-radius" role="banner" style="background-image:url(<?php echo $background_url ?>);<?php echo $display_none; ?>">
						</div>
					</div>
