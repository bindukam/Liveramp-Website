		...
		<div class="grid-center">
			...
			<div class="col-12 filter-search">
				<form id="search" class="grid-middle">
					<input type="search" name="search" placeholder="Search for a Partner" class="col-12"> <span class="nc-icon-outline ui-1_zoom col-2"></span> </form>
			</div>
			<div class="col-12">
				<ul class="filter-list grid-1_md-2_lg-5">
					<li class="filter-item col">
						<div class="filter__name"> <span class="nc-icon-outline arrows-1_minimal-down"></span> </div>
				...
				<section class="pad-half logos-block" style="width:100%;">
					<div>
								...
								<div>
									<article>
										<a href="">
											...
											<img alt="{{ item.name }}" class="optimized"> <img alt="{{ item.name }}"> </a>
									</article>
								</div>
							</li>
							<!-- end list item -->
						...
						<p class="no-results">
							<?php _translate('there_are_no_items_for_this_search_criteria')  ?>.</p>
						<div class="center">
							<div class="btn load-more">
								...
								} ?> <span><?php echo $load_more_text; ?></span> <i class="nc-icon-outline arrows-1_minimal-down"></i> </div>
						</div>
					</div>
				</section>
				<!--NUMBER OF QUERIES:
