<div class="wrapper" id="panel-00-header">
    <div class="container header" style="position: relative;">
        <div class="logo"><a href="/tech-stack-integration-for-identity-resolution/"><img src="<?php echo $asset_link; ?>/assets/images/logo-liveramp.svg"></a></div>
        <div class="nav">
            <ul class="click-menu">
    ...
    <div class="signup <?php if ($where=='header') echo 'hide';?>">
        <span class="close" id="click-close"><img src="<?php echo $asset_link; ?>/assets/images/icon-close.svg"></span>
...
<div class="thankyou hide">
    ...
    <span class="close click-close-thankyou"><img src="<?php echo $asset_link; ?>/assets/images/icon-close.svg"></span>
</div>
