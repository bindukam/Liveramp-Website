    ...
    if ( !is_front_page() ) {
        ...
        if ( is_archive() && !is_tax() && !is_category() && !is_tag() ) {
	        ...
	        if($post_type != 'post') {
		        ...
		        if( $post_type === 'events' || $post_type === 'news' ) {
			        ...
			        echo '<li class="item-cat item-custom-post-type-' . $post_type . '"><a class="bread-cat bread-custom-post-type-' . $post_type . '" href="/' .$archive_slug. '/" title="' . $post_type_object->labels->name . '">' . $post_type_object->labels->name . '</a></li>';
			        echo '<li class="separator"> ' . $separator . ' </li>';
            ...
            if( $post->post_parent ){
                ...
                echo '<li class="item-current item-' . $post->ID . '"><span class="bread-current bread-' . $post->ID . '"> ' . $page_title . '</span></li>';
