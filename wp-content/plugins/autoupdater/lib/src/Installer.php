...
class AutoUpdater_Installer
{
     ...
     * @return void
     */
    protected function setup_wpe_whitelabel()
    {
        AutoUpdater_Config::set('autoupdater_encryption', 1);
        AutoUpdater_Config::set('autoupdater_ssl_verify', 1);
        AutoUpdater_Config::set('autoupdater_protect_child', 1);
        AutoUpdater_Config::set('autoupdater_whitelabel_child_page', "WP Engine Smart Plugin Manager simplifies plugin management by automatically updating your plugins every day and ensuring your site continues to work as expected.");
        AutoUpdater_Config::set('autoupdater_page_unavailable_template', "<div>" .
