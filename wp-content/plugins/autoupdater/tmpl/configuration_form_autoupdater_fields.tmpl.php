<table class="form-table">
    <tbody>
    <tr id="autoupdater_enable" style="display:none;">
        <th scope="row">
            <label>
    ...
    <tr id="autoupdater_update_cms" style="display:none;">
        <th scope="row">
            <label>
    ...
    <tr id="autoupdater_update_extensions" style="display:none;">
        <th scope="row">
            <label>
    ...
    <tr id="autoupdater_update_themes"  style="display:none;">
        <th scope="row">
            <label>
    ...
    <tr id="autoupdater_excluded_themes" style="display:none;">
        <th scope="row">
            <label>
    ...
    <tr id="autoupdater_notification_email">
        <th scope="row">
